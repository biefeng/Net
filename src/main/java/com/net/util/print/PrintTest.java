...
public class PrintTest implements Printable {
    ...
    private static List<DemoDto> getDemoDto() {
        ...
        dtos.add(new DemoDto("阿萨德是打发发发", "惠普打印机", "技术支持部", "责任人01", new Date(), "D:\\a.PNG", "宝丰戒毒所"));
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        switch (pageIndex) {
            case 0:
                ...
                /**
                 * 参数2：打印的x坐标起点 参数3 打印的y坐标起点 参数4：打印图片的宽度 参数5：打印图片的高度
                 */
                //g2.drawImage(src, (int) 80, (int) 25, (int) 48, (int) 48, c);
                // 标题，固定不变
                g2.drawString(DEMODTO_LIST.get(COUNT).getTitle(), (float) 50, (float) 30);
                // 以下为动态的文字内容
                ...
                g2.drawString("启用日期：2019-2-23 9:00:00", (float) 10, (float) 70);
