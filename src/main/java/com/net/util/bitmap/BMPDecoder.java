...
public class BMPDecoder {
  ...
  public static void main(String[] args) throws Exception {
    BMPDecoder bmpDecoder = new BMPDecoder(new FileInputStream("d:/doc/T11.png"));
    BufferedImage bufferedImage = bmpDecoder.getBufferedImage();
    byte[] bytes = ImagePixelUtils.imagePixelToPosByte_8(bufferedImage, 33);
  }
